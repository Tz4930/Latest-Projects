	...
	render() {
    	return (
    		<>
			    ...
			    <section style={{marginLeft: "40px"}} className="section pt-5 pb-5 products-section">
			         <Container>
			         	<SectionHeading 
			    ...
			    {/* <section style={{marginLeft: "40px"}} className="section pt-5 pb-5 bg-white becomemember-section border-bottom">
			         <Container>
			         	<SectionHeading 
