			   ...
			   <Container>
			      <Navbar.Brand to="/">
					  <Nav.Link eventKey={0} as={NavLink} exact to="/">
						<Link to="/">
					  <img src="./img/appulogo.jpeg" className="header-logo-image" />
					  </Link>
			            </Nav.Link>
			      ...
			      <Navbar.Collapse id="navbarNavDropdown">
			         <Nav activeKey={0} className="ml-auto" onSelect={this.closeMenu}>
						...
						{console.log("sdjkgakhgkajsghjk", !user)}
				{!user ? (
					<>
					<section className="section pt-4 pb-4 bg-white ">
			         <Container>
			            <Row>
			               <Col sm={12} className="text-center">
			                  <Link to="/register" className="btn btn-success">
							   List Your Business <FontAwesome icon='chevron-circle-right' />
			                  </Link>
			               </Col>
			            </Row>
			         </Container>
					   ...
					   <Row>
						  <Col sm={12} className="text-center">
							 <Link to="/login" className="btn btn-success">
							  Login <FontAwesome icon='chevron-circle-right' />
							 </Link>
						  </Col>
					   </Row>
					</Container>
						...
						<Row>
						   <Col sm={12} className="text-center">
							  <Link to="/dashboard" className="btn btn-success">
							   My Account <FontAwesome icon='chevron-circle-right' />
							  </Link>
						   </Col>
						</Row>
					 </Container>
				   ...
				   <Row>
					  <Col sm={12} className="text-center">
						 <Link to="#" className="btn btn-success">
						  LogOut <FontAwesome icon='chevron-circle-right' />
						 </Link>
					  </Col>
				   </Row>
				</Container>
